...
const StyledTelegramIcon = styled.svg<TelegramIconProps>`
...
const TelegramIcon: React.FC<TelegramIconProps> = ({margin, padding, cursor}) => {
    return (
        <StyledTelegramIcon margin={margin} padding={padding} cursor={cursor} viewBox="0 0 24 24"
